...
(async () => {
  ...
  describe('Verifica a criação da tabela auvo_task_status', () => {
    ...
    it('Deve verificar se a tabela "auvo_task_status" possui todas as colunas definidas', async () => {
  ...
  describe('Verifica a criação da tabela auvo_task_priorities', () => {
    ...
    it('Deve verificar se a tabela "auvo_task_priorities" possui todas as colunas definidas', async () => {
  ...
  describe('Verifica a criação da tabela auvo_task_type_requirements', () => {
    ...
    it('Deve verificar se a tabela "auvo_task_type_requirements" possui todas as colunas definidas', async () => {
      const columnsList = [
  ...
  describe('Verifica a criação da tabela auvo_tasks', () => {
    ...
    it('Deve verificar se a tabela "auvo_tasks" possui todas as colunas definidas', async () => {
  ...
  describe('Verifica a criação da tabela auvo_task_attachments', () => {
    ...
    it('Deve verificar se a tabela "auvo_task_attachments" possui todas as colunas definidas', async () => {
      const columnsList = [
        'attachmentId',
        'fk_taskId',
        'url',
  ...
  describe('Verifica a criação da tabela auvo_questionnaire_answers', () => {
    ...
    it('Deve verificar se a tabela "auvo_questionnaire_answers" possui todas as colunas definidas', async () => {
  ...
  describe('Teste de erro na criação das tabelas de usuários', () => {
