...
import auvoQuestionnariesTables from '../../infrastructure/database/tables/auvoQuestionnariesTables.ts';
...
(async () => {
  ...
  describe('Verifica criação da tabela auvo_questionnaires', () => {
    ...
    it(`Deve verificar se a tabela "auvo_questionnaires" tem todas as colunas definidas`, async () => {
  ...
  describe('Verifica criação da tabela auvo_questionnaire_questions', () => {
    ...
    it(`Deve verificar se a tabela "auvo_questionnaire_questions" tem todas as colunas definidas`, async () => {
      const columnsList = [
        'questionId',
        'questionnaireId',
        'answerType',
